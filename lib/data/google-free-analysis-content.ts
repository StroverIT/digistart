...
export const googleFreeAnalysisContent = {
  ...
  tipsCta: {
    ...
    description:
      "Вземи безплатно видео, което ти показва първите три неща, които правим, когато започнем работа с локален бизнес, за да го класираме в топ 3. Не ти трябват технически умения.",
