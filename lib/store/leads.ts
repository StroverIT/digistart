...
const demoLeads: BusinessLead[] = [
  {
    ...
    notes: "Интересуват се от уеб сайт и социални мрежи",
  ...
  },
  {
    ...
    status: "declined",
    notes: "Вече имат уеб сайт, не се интересуват в момента",
  ...
  },
  {
    ...
    purchasedServices: [
      {
        serviceId: "website",
        serviceName: "Уеб сайт",
        optionName: "Професионален сайт",
        price: 250,
        isMonthly: false,
