        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              `Записахме имейла ви: ${params.email}. При официалния старт ще ви изпратим 10% отстъпка върху всички наши услуги — без код в този имейл; детайлите идват със старта.`,
            ),
          ),
          React.createElement(
            Section,
