...
export function ThreeFreeTipsStage3Email() {
  return (
    <TipsStageEmailShell previewText="Фокусиране върху това, което има значение. Всичко останало е второстепенно.">
      ...
      <TipsStageBodyText>
        Мноооооооого отдавна четох една книга от Михай Чиксентмихай.
        <br />
        (Представете си да трябва да спелувате това име на някого)
      </TipsStageBodyText>
      ...
      <TipsStageBodyText>И след това избирам нови топ 3.</TipsStageBodyText>
      ...
      <TipsStageBodyText emphasis>Влезте в потока.</TipsStageBodyText>
...
export default ThreeFreeTipsStage3Email;
