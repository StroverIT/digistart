    ...
    >
      ...
      <div className="relative z-10">
        <ServiceDetailHero
          ...
          description={
            <>
              Поддържаме профилите ти с ясна стратегия, редовни публикации и възможност за
              реклами. Ти се фокусираш върху бизнеса, а ние помагаме съдържанието да изглежда
              професионално и да привлича клиенти.
            </>
          }
          priceSlot={
