...
const marketingSolutionItems = [
  "Органично съдържание (Meta или TikTok): Създаване и публикуване на ангажиращи постове, каросели, сторита и Reels 3 пъти седмично за един канал по твой избор.",
