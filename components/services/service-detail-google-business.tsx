...
const googleSteps = [
  {
    ...
    text: "Създаваме и оптимизираме Google Business профила за твоя физически магазин - категории, ключови думи и локация, за да се виждаш, когато някой наблизо търси стоката ти.",
    icon: MapPin,
  },
  {
    title: "Верификация и разширения",
    text: "Поемаме верификацията пред Google (видео, телефон или поща). По желание добавяш месечни публикации или присъствие в Waze и Apple Maps - за още повече пътища към вратата ти.",
    icon: MonitorCheck,
  },
  {
    title: "Безплатен локален трафик",
    text: "Профилът работи като дигитална визитка 24/7: обаждания, маршрути, отзиви и посещения от хора с готово намерение да купят - без да плащаш за всеки клик като в рекламата.",
    icon: Rocket,
  },
] as const;
...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      'Защото платформите служат за различно. Във Facebook хората скролват и разглеждат. В Google вече са решили да купят - пишат „магазин за рокли близо до мен“ или „магазин за обувки [град]“. Верифицираният физически обект на картата е твоето №1 оръжие срещу анонимните само-онлайн магазини: показва, че си реален, на адрес, с отзиви - не „страница без адрес“. Ако липсваш в Maps, горещият клиент влиза при конкурента на 200 м.',
  },
  {
    question: "2. Плаща ли се месечна такса на Google, за да съм на картата?",
    answer:
      "Не. Google Maps и Business Profile са безплатни. Плащаш ни еднократно €49 за професионално изграждане, верификация и локално SEO. След това профилът носи посещения и обаждания без месечна такса към Google. (По желание - месечна поддръжка и публикации, ако искаш да доминираш над другите магазини в квартала.)",
  },
  {
    question: "3. Защо да плащам на агенция, не мога ли да си го направя сам?",
    answer:
      "Можеш, но много магазини остават неверифицирани, с грешна категория или на задна страница в резултатите. Ние знаем кои думи работят за retail („бутик“, „магазин за …“, твоят град), как да структурираме продуктите в профила и как да минем верификацията бързо - докато ти си на щанда, не в настройките на Google.",
  },
  {
    question: "4. Колко време отнема да се появя на картата?",
    answer:
      "Оптимизацията от наша страна - няколко дни. След това верификация от Google (1–14 дни според метода: видео, телефон или писмо). Веднъж активен, започваш да се виждаш при локални търсения - първите маршрути и обаждания често идват още в първите седмици.",
  },
  {
    question:
      "5. Как стои въпросът с фалшиви негативни ревюта от конкуренти?",
    answer:
      "Директно само Google може да премахне отзив. Предлагаме добавка: подготвяме официални рапорти към Google за злонамерени или явно фалшиви ревюта — важно е, ако се бориш за доверие срещу евтиния онлайн.",
  },
  {
    question: "6. Как мога лесно да събирам повече 5-звездни отзиви?",
    answer:
      "Отзивите са ключ за локалното класиране. При настройката ти даваме директен линк за оценка - пращаш го на доволни клиенти след покупка на каса. Повече реални 5-звездни отзива = повече хора избират твоя обект вместо празния или съмнителен профил на конкурента.",
  },
];
    ...
    >
      ...
      <div className="relative z-10">
        <ServiceDetailHero
          ...
          description={
            <>
              За еднократна такса поставяме бизнеса ти на дигиталната карта. Накарай
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-8 md:mb-12">
              ...
              <p
                ...
                className="text-muted-foreground text-lg leading-relaxed opacity-0 translate-y-10"
              >
                За собственици на магазини с физически обект - преди да инвестираш €49 в локална
                видимост.
              </p>
            </div>
            <div
