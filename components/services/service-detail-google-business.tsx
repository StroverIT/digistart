...
const googleSteps = [
  ...
  {
    title: "Привличай безплатен трафик",
    text: "Плащаш и ние превръщаме профила ти в ясна дигитална визитка, която носи обаждания, запитвания и посещения от хора с реално намерение.",
    icon: Rocket,
  },
] as const;
