...
const solutionItems = [
  ...
  "Форми за контакт: Клиентите лесно изпращат запитвания.",
...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      "Стандартната изработка на сайт отнема между 3 и 4 работни дни след получаване на нужните материали от твоя страна. Процесът е оптимизиран, за да стартираш възможно най-бързо и без излишно чакане.",
  },
  {
