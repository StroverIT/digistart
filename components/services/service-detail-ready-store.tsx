...
const PAIN_POINTS = [
  {
    ...
    text: "Над 50% от българите пазаруват онлайн вечер. Физическият ти магазин работи само от 09:00 до 19:00, докато онлайн магазинът продава 24/7.",
  },
  {
    title: "Конкуренцията ти краде пазара",
    text: "Докато си ограничен от физическия си град или квартал, конкуренти от други градове крадат вашите локални клиенти онлайн.",
  },
  {
    title: "Липсва ти дигитална витрина",
    text: "Хората искат да разгледат какво имате, преди да се разходят до магазина. Дигиталният каталог ги стимулира да дойдат на място.",
  },
  {
    title: "Изпускаш клиенти в пиковите часове",
    text: "Когато стават опашки, клиентите се отказват, а наемането на още продавач-консултанти е непосилно. Онлайн платформата обслужва хиляди едновременно.",
  },
  {
    title: "Хората мразят трафика",
    text: "Клиентите често нямат време да пътуват до вас в трафика. Те търсят доставка до врата или офис (еконт/спиди).",
  },
  {
    title: "Губиш по 2-3 часа на ден в ръчна работа",
    text: "Автоматичното генериране на товарителници директно от сайта пести по 2-3 часа на ден от твоето време, което иначе губиш в администрация.",
  },
] as const;
      ...
      <section data-animate-section className="py-8 md:py-20 bg-card/50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-8 md:mb-12">
            ...
            >
              Физическият обект има работно време. Твоят онлайн магазин - не.
            </p>
          </div>
      ...
      <section data-animate-section className="py-8 md:py-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-8 md:mb-12">
            ...
            >
              Как да стартираш продажбите?
            </h2>
            <p
              data-animate-reveal
              className="text-muted-foreground text-lg leading-relaxed opacity-0 translate-y-10"
            >
              От физически обект до автоматизирани продажби в цялата страна — само 3 лесни стъпки.
            </p>
          </div>
