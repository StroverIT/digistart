...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Пакетът "Готов Онлайн Магазин" включва качването на първите 20 продукта от наша страна (със снимки, описания и цени, предоставени от теб), за да имаш напълно завършен вид при старта. След това можеш да качваш неограничен брой продукти сам, или да използваш нашата добавка за масово качване.',
  },
  {
