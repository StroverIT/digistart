...
const heroFeatures = [
  {
    icon: ShieldCheck,
    label: "Пълна верификация",
    hint: "Официален и потвърден профил в Google",
  },
  {
    icon: MapPin,
    label: "Оптимизация за търсене",
    hint: "Излизаш първи при локални заявки",
  },
  {
    icon: LayoutGrid,
    label: "Дигитална витрина",
    hint: "Работно време, контакти, снимки и продукти на едно място",
  },
] as const;
      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 lg:items-center lg:gap-16">
        <div className="flex w-full flex-col items-center text-center">
          ...
          <h1 className="font-heading mt-4 text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-[3.25rem] lg:leading-[1.1]">
            Стани видим там, където клиентите те търсят.
          </h1>
          <p className={cn("mt-4 max-w-2xl", LANDING_BODY_CLASS)}>
            Превръщаме бизнеса ти в първи избор при търсене в Google Maps и Търсене. Ние
            изграждаме, верифицираме и подреждаме профила ти, за да насочваме реален трафик към
            физическия ти обект.
          </p>
        ...
        <article className="w-full max-w-4xl flex-1">
          <div className="overflow-hidden rounded-2xl border border-border/80 bg-muted/40 p-2 shadow-xl shadow-primary/5 sm:p-3">
            <ImagePlaceholder
              width={1280}
              height={720}
              label="Hero визуализация на Google Business профил"
