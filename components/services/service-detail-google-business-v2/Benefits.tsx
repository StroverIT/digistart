...
const HOW_WE_HELP_BLOCKS = [
  ...
  },
  {
    ...
    description:
      "Оптимизираме профила ти с правилните ключови думи. Ако някой търси „най-близкото кафене“, „железария“ или „фризьор“, твоят бизнес излиза на предни позиции в картите.",
    layout: "icon" as const,
    gridArea: "local",
  },
  {
  ...
  },
  {
    ...
    description:
      "Качваме актуални снимки на обекта, менюто или най-продаваните ти услуги. Клиентите виждат точно какво предлагаш още преди да са прекрачили прага ти.",
    layout: "icon" as const,
    gridArea: "showcase",
  },
  {
