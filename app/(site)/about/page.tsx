      ...
      <div className="container mx-auto px-4 space-y-16 md:space-y-20">
        <section className="max-w-4xl mx-auto text-center space-y-5">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto">
            Ние сме екипът, който ще изгради твоя дигитален дом, докато ти се
            фокусираш върху физическия си магазин.
          </p>
        </section>
        ...
        <section className="max-w-4xl mx-auto rounded-2xl border border-border bg-card p-6 sm:p-8 md:p-10 space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Вярваме, че всеки добър физически магазин заслужава да продава
            онлайн. Без хаос, без бавни процеси и без компромис с качеството.
            Нашата цел е да пренесем твоя бизнес в дигиталния свят възможно
            най-бързо и професионално, за да спреш да губиш пари и време.
          </p>
        </section>
