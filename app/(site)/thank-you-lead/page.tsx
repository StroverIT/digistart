...
function ThankYouLeadContent() {
  ...
  return (
    <div className="relative min-h-[70vh] overflow-hidden pb-16 pt-24">
      <div className="pointer-events-none absolute inset-0">
        <ConfettiRenderer />
      </div>

      <div className="container mx-auto px-4">
        <div ref={rootRef} className="relative z-10 mx-auto max-w-2xl text-center">
          <div
            data-lead-success-icon
            className="relative mb-8 translate-y-10 opacity-0"
          >
